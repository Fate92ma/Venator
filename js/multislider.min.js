...
! function (n) {
    n.fn.multislider = function (e, t) {
        ...
        function S() {
            P(), r = A.width();
            var n = parseInt(v.find(".ms-item:first").css("padding-left")),
                e = parseInt(v.find(".ms-item:first").css("padding-right"));
            0 !== n && (r += n), 0 !== e && (r += e)
        }
        ...
        function P() {
            A = v.find(".ms-item:first"), s = v.find(".ms-item:last")
        }
        ...
        function M() {
            U(function () {
                P(),
                    function () {
                        d = m.duration;
                        var n = parseFloat(v.find(".ms-item:first").css("margin-left"));
                        d *= 1 - n / -(r - 1)
                    }(), A.animate({
                        marginLeft: -(r + 1)
                    }, {
        ...
        function x() {
            U(function () {
                P(), b();
                var e = v.children(".ms-item").clone().splice(0, a);
                v.append(e), A.animate({
                    ...
                    easing: "swing",
                    complete: function () {
                        n(v.children(".ms-item").splice(0, a)).remove(), y()
                    }
                })
            })
        }
        ...
        function B() {
            U(function () {
                P(), b();
                var e = v.children(".ms-item").length,
                    t = v.children(".ms-item").clone().splice(e - a, e);
                n(n(t)[0]).css("margin-left", -o), v.prepend(t), P(), A.animate({
                    ...
                    easing: "swing",
                    complete: function () {
                        e = v.find(".ms-item").length, n(v.find(".ms-item").splice(e - a, e)).remove(), A.removeAttr("style"), y()
                    }
                })
            })
        }
        ...
        return "object" != typeof e && void 0 !== e || (v.contents().filter(function () {
            ...
            y(), v.children(".ms-item:first").stop()
